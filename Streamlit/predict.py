...
data_dir = 'C://Users/NYANSAPO/Desktop/Mini Project/Dataset'     # Change directory to fit your work

transformations = transforms.Compose([transforms.Resize((150, 150)), transforms.ToTensor()])
...
load_model.load_state_dict(torch.load('C://Users/NYANSAPO/Desktop/Mini Project/Model/resNet50.pth', map_location=torch.device('cpu')))    # Change directory to fit your work
load_model.eval()
